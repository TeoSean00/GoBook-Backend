...
sample_data = [
    ...
    "email" : "keith.loh.2021@smu.edu.sg",
    "name": "Test User 1",
    "preferences": [],
    "attended_classes": [],
    "reviews": [
    ...
    "email" : "joseph.hee.2021@smu.edu.sg",
    "name": "Test User 2",
    "preferences": [],
    "attended_classes": [],
    "reviews": []
    ...
    "email" : "tyler.lian.2021@smu.edu.sg",
    "name": "Test User 3",
    "preferences": [],
    "attended_classes": [],
    "reviews": [
...
print(f"Flask app is initialized on port {portNum}")